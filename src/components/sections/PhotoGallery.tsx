    ...
    <section id="gallery" className="py-24 relative overflow-hidden">
      ...
      <div className="container relative z-10 px-4">
        ...
        <div className="text-center mb-16">
          <Badge variant="outline" className="mb-4 px-4 py-1 border-accent/50 text-accent">
            Gallery
          </Badge>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-6xl mx-auto">
          {galleryImages.map((image, index) => (
            <div
              key={image.id}
              className="group relative aspect-video rounded-xl overflow-hidden glass-card border border-border/50 
            ...
            >
              ...
              <div className="absolute inset-0 flex items-center justify-center">
                <div className="text-center">
                  ...
                  <p className="text-foreground font-medium">{image.placeholder}</p>
                  <p className="text-muted-foreground text-sm mt-1">Add your photo</p>
                </div>
              </div>
