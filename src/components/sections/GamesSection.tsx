        ...
        <div className="text-center max-w-4xl mx-auto">
          ...
          <div className="flex flex-wrap justify-center gap-3 mb-12">
            {games.map((game, index) => (
              <span
                key={game}
                className="px-6 py-3 rounded-full glass-card border border-border/50 text-foreground font-medium 
          ...
          {/* Highlighted message */}
          <div className="glass-card neon-border-purple rounded-2xl p-8 max-w-2xl mx-auto">
